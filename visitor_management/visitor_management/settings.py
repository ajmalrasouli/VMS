...
SECRET_KEY = 'django-insecure-2s0&)5r6!of-rv39^cna_t2i)u^g4-l6$158s8d(oz8u_7e)2z'
...
LOGOUT_REDIRECT_URL = 'home'  # Redirect to 'home' after successful logout
LOGIN_REDIRECT_URL = '/visitors/dashboard/'
LOGOUT_REDIRECT_URL = '/'
